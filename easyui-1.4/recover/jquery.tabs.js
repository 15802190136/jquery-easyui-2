(function($) {
	...
	/**
	 * update tab panel, param has following properties: tab: the tab panel to be updated options: the tab panel options type: the update type, possible values are: 'header','body','all'
	 */
