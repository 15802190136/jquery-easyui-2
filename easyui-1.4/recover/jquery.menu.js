(function($) {
	...
	/**
	 * show the menu, the 'param' object has one or more properties: left: the left position to display top: the top position to display menu: the menu to display, if not defined, the 'target menu' is used parent: the parent menu item to align to
	...
	$.fn.menu.methods = {
		...
		/**
		 * get the menu item data that contains the following property: { target: DOM object, the menu item id: the menu id text: the menu item text iconCls: the icon class href: a remote address to redirect to onclick: a function to be called when
		 * the item is clicked }
		 */
